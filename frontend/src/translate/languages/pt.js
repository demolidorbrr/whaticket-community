  ...
  pt: {
    translations: {
      ...
      transferTicketModal: {
        ...
        fieldLabel: "Selecionar usuários",
        fieldQueueLabel: "Transferir para fila",
        fieldConnectionLabel: "Transferir para conexão",
        fieldQueuePlaceholder: "Selecione uma fila",
        fieldConnectionPlaceholder: "Selecione uma conexão",
        noOptions: "Nenhum usuario cadastrado",
        buttons: {
          ok: "Transferir",
          cancel: "Cancelar",
        },
      ...
      backendErrors: {
        ...
        ERR_WAPP_SELECTION_REQUIRED:
          "Selecione a conexão (whatsappId) para evitar mistura entre empresas.",
        ...
        ERR_INVALID_TOKEN: "Sessão expirada. Por favor entre.",
